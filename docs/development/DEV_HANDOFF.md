...
- Production checkout: `C:\NimbaOS\nimba`, branch `main`, deployed commit `15e9100`.
...
- Public `app.nimbaos.ru` remains unavailable through the current Cloudflare Tunnel path; this is an ingress/network blocker, not an application-health failure.
