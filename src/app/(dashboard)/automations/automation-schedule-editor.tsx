...
export function AutomationScheduleEditor({
  ...
  function patch(patchValue: Partial<AutomationSchedule>) {
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <Select
            ...
            disabled={disabled}
            onValueChange={(value) => patch({ cadence: value as AutomationSchedule['cadence'] })}
          >
            <SelectTrigger><SelectValue /></SelectTrigger>
            <SelectContent>
              <SelectItem value="daily">Каждый день</SelectItem>
              <SelectItem value="weekly">Каждую неделю</SelectItem>
              <SelectItem value="every-n-weeks">Раз в несколько недель</SelectItem>
        ...
        <div>
          ...
          <Select
            ...
            disabled={disabled}
            onValueChange={(value) => patch({ timeMode: value as AutomationSchedule['timeMode'] })}
          >
            <SelectTrigger><SelectValue /></SelectTrigger>
            <SelectContent>
              <SelectItem value="times">В выбранное время</SelectItem>
              <SelectItem value="interval">С интервалом в диапазоне</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
