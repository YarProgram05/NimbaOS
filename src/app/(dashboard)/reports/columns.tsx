        ...
        <span className={`flex items-center gap-1 ${isSizeRow ? 'pl-5' : ''}`}>
          {canExpand ? (
            <button
              ...
              className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-md hover:bg-muted md:h-5 md:w-5 md:rounded-sm"
            ...
            <span className="hidden h-5 w-5 shrink-0 md:inline-block" />
          )}
